# 16-Channel-Servo-Controller Documentation

This repository contains the 16-Channel-Servo-Controller VitePress documentation site. The
...
The staged production files are generated in `projects/16-Channel-Servo-Controller/en/latest/`.
...
```text
https://GITHUB-USERNAME.github.io/16-Channel-Servo-Controller-vite/projects/16-Channel-Servo-Controller/en/latest/
```

The public-facing URL (via the baota Nginx reverse proxy) is:

```text
https://wiki-test.hiwonder.com/projects/16-Channel-Servo-Controller/en/latest/
```
